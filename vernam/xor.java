...
public class XOR {
    public static void main(String args[]) {
        ...
        // This would be our Vernam cipher (should be the same length as our text)
        ...
        System.out.println(arCipher);
        
        // Array to hold our encryption (again the same length)
        char[] encoded = new char[5];
        
        // Encrypt the text by using XOR (exclusive OR) each character
        // of our text against the cipher.
